...
**Date** 2026-09-09 · **Status** accepted, **amended** by `decisions/0012` (2026-09-11)

> **Amendment.** Everything below stands except the *count*. `decisions/0012` replaced the three
...
> read `0012` for what the one vault had to absorb to replace three, and for the two properties
> that were given up.
