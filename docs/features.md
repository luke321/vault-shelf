...
![A library of your notes](https://raw.githubusercontent.com/luke321/vault-shelf/1.1.0/docs/features/open.webp)

Browse the same vault as shelves of books. A note can belong in several books while staying in its original file.

[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/open.md) · `design/0002`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/room.md) · `design/0009`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/shelves.md) · `design/0002`

### A closer look at a spine

![A closer look at a spine](https://raw.githubusercontent.com/luke321/vault-shelf/1.1.0/docs/features/peek.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/peek.md) · `design/0011`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/close.md) · `design/0012`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/favourite.md) · `design/0019-the-favourites-shelf`

### Make a book

![Make a book](https://raw.githubusercontent.com/luke321/vault-shelf/1.1.0/docs/features/makebook.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/makebook.md) · `design/0020`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/editbook.md) · `design/0020`

### A place for another book

![A place for another book](https://raw.githubusercontent.com/luke321/vault-shelf/1.1.0/docs/features/plusbook.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/plusbook.md) · `design/0020`

### Arrange books by hand

![Arrange books by hand](https://raw.githubusercontent.com/luke321/vault-shelf/1.1.0/docs/features/rearrange.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/rearrange.md) · `design/0018`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/edge.md) · `design/0024`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/build.md) · `design/0002`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/manage.md) · `design/0009`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/looks.md) · `design/0029`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/plaques.md) · `design/0019-a-plaque-opens-its-run`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/parting.md) · `design/0008`, `design/0027`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/autocomplete.md) · `design/0026-the-search-vocabulary`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/read.md) · `design/0004`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/turn.md) · `design/0028`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/index.md) · `design/0015`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/contentsorder.md) · `design/0030`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/alsoin.md) · `design/0010`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/ribbon.md) · `design/0008`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.1.0/docs/features/wear.md) · `design/0008`
