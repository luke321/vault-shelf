...
Browse, collect, arrange and read the same notes in different ways. These clips use the
generated vault, recorded at 1000 × 1000. The [live demo](demo/) lets you try the library yourself.

[Overview](#overview) · [Collect and arrange](#collect-and-arrange) · [Shape the library](#shape-the-library) · [Find and read](#find-and-read) · [Keep your place](#keep-your-place)

## Overview

### A library of your notes

![A library of your notes](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/open.webp)

Browse the same vault as shelves of books. A note can belong in several books while staying in its original file.

[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/open.md) · `design/0002`

### The reading room

![The reading room](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/room.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/room.md) · `design/0009`

### Six shelves to start

![Six shelves to start](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/shelves.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/shelves.md) · `design/0002`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/peek.md) · `design/0011`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/close.md) · `design/0012`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/favourite.md) · `design/0019-the-favourites-shelf`

### Make a book

![Make a book](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/makebook.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/makebook.md) · `design/0020`

### Edit a book

![Edit a book](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/editbook.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/editbook.md) · `design/0020`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/plusbook.md) · `design/0020`

### Arrange books by hand

![Arrange books by hand](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/rearrange.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/rearrange.md) · `design/0018`

### Reach the next shelf

![Reach the next shelf](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/edge.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/edge.md) · `design/0024`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/build.md) · `design/0002`

### Manage your shelves

![Manage your shelves](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/manage.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/manage.md) · `design/0009`

### Colours and leather bindings

![Colours and leather bindings](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/looks.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/looks.md) · `design/0029`

### Open a whole run

![Open a whole run](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/plaques.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/plaques.md) · `design/0019-a-plaque-opens-its-run`
...
Open a matching book and the left contents scroll to the first match, keeping your selected note on the right. Marked rows show every match. The note highlights
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/parting.md) · `design/0008`, `design/0027`
...
Matching books no longer stand equally tall. A book lifts and opens air in proportion to the share of its own notes that matched: a half or more is the top rung, then a fifth, then a twentieth, then a bare match at the floor. The book that is the answer stands clearly proud of the ones that merely mention it.

[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/matchweight.md) · `design/0008`
...
As you type, suggestions offer people, tags, folders, the names printed on book covers and note titles. Use the arrow keys and Enter, or click a suggestion, to complete the search. The offered words and the library's matches use the same catalogue of names. A small × beside the box clears the search without touching any active filter.

[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/autocomplete.md) · `design/0026-the-search-vocabulary`
...
When the open book is about something the note contains — a tag, a person, a property — small flags stand on the fore-edge of the right-hand page, one for each place that subject is written. Press one and the note scrolls there with that occurrence marked. A subject only declared in the frontmatter gets a hollow flag on the note's details line, which is where it actually is.

[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/sticky.md) · `design/0037`

### Read a two-page spread

![Read a two-page spread](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/read.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/read.md) · `design/0004`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/turn.md) · `design/0028`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/index.md) · `design/0015`
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/contentsorder.md) · `design/0030`

### See another collection

![See another collection](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/alsoin.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/alsoin.md) · `design/0010`

## Keep your place

### Keep a ribbon in it

![Keep a ribbon in it](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/ribbon.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/ribbon.md) · `design/0008`

### Books carry their age and use

![Books carry their age and use](https://raw.githubusercontent.com/luke321/vault-shelf/1.2.0/docs/features/wear.webp)
...
[Clip recipe](https://github.com/luke321/vault-shelf/blob/1.2.0/docs/features/wear.md) · `design/0008`

## What stays true

- Shelves count unique notes, even when several books contain the same one.
- Missing dates and properties get Undated or Unfiled books. Dates use chosen properties,
  then the title, then an optional file timestamp; people come from declared properties or
  links to declared person notes.
- Hiding keeps a shelf's definition and books. Deleting a shelf or made book never deletes notes.
- The plugin follows changes in your vault, writes nothing to notes and makes no network requests.
- Keyboard controls, named buttons, visible focus, reduced motion and a plain list mode keep
  the library usable in more than one way.
- Leather is the offered look. Modern and Cyber remain shelved.

The [README](https://github.com/luke321/vault-shelf#readme) covers installation, settings and
the standalone exporter. The [design records](https://github.com/luke321/vault-shelf/tree/1.0.0/.ai-context)
explain the choices behind the library.
