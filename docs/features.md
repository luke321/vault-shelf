...
**decade**. "September 2026" in 11px vertical type is not how anybody finds September 2026.
...
| | |
|---|---|
| **Default** | the library belongs to your Obsidian: it reads the host's theme and repaints when the theme changes |
| **Leather** | 19th-century bindings, gilt stamping, raised bands, a stained plank, brass plaques and an open book lying on marbled endpapers. It has its own colours, its own light and its own furniture, and it ignores the theme on purpose |
| **Cyberpunk** | a dark neon room. The newest of the three and still filling in |
...
that on — from the earliest stamp the filesystem has. People come from the people property and
