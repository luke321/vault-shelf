...
const all = [];
/* github#39, decisions/0012 -- a check names the shapes it needs; all three by default */
...
/* github#39, decisions/0012 -- a ceiling, not a default; --jobs only goes down */
const LANE_CAP = 2;
...
/**
 * github#39, decisions/0012 -- what the page is still doing.
...
async function runOne(vault, work) {
  ...
  try {
    ...
    for (const c of mine) {
      ...
      /* github#39, decisions/0012 -- blame the check that left it, not its neighbour */
...
async function main() {
  ...
  /* github#39, decisions/0012 -- a lane is a whole browser; open one only for real work */
