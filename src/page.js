...
function mountVaultShelf(root, data, options) {
   ...
   * github#34, design/0023 -- a drag can only reach what is on screen
   * github#34, design/0023 -- so the room scrolls when the pointer nears an edge
   * github#34, design/0023 -- VERTICAL ONLY, and never horizontal: design/0014
   */
   ...
   */
  var edgeAt = null;
  /** github#34, design/0023 -- true while the tick replays a dragover */
  var edgeReplaying = false;

  /**
   * github#34, design/0023 -- px per tick at this height, signed
  ...
  /**
   * github#34, design/0023 -- THE MARK IS GEOMETRY, NOT THE LAST EVENT
   * github#34, design/0023 -- the room moves under a still pointer, so replay
   * github#34, design/0023 -- one dragover where it is and let the rows re-read
  ...
  /**
   * github#34, design/0023 -- INCREMENTS, NOT A TARGET: a height that firms up
   * github#34, design/0023 -- mid-scroll extends the runway, so no settle dance
   * @param {HTMLElement} lib
   */
  ...
  /**
   * github#34, design/0023 -- only while the page itself carries something
   * github#34, design/0023 -- a file dragged in from the desktop moves nothing
   * @param {HTMLElement} lib
   */
  ...
  API = {
    ...
    /** github#34, design/0023 -- the edge scroll, and where the room stands */
    edgeScroll: function () {
      var lib = $("library");
      return {
        running: !!edgeTimer,
