...
function mountVaultShelf(root, data, options) {
  ...
  function renderNote() {
    ...
    if (opts.renderNote) {
      /* github#40, design/0026 -- the host's renderer settles after goTo has returned */
      attempt(function () {
   ...
   * github#40, design/0026 -- 85% of notes never overflow, so the push is uniform
   * github#40, design/0026 -- one flick turns one page: the latch clears on quiet
  ...
  /** github#40, design/0026 -- where a turn arrives @param {"top"|"bottom"} land */
  ...
  /**
   * github#40, design/0026 -- the band lets go, and says so until it has
  ...
  /* github#40, design/0026 -- the accumulation goes; the latch is not the accumulation */
  ...
  /** github#40, design/0026 -- the whole gesture @param {Event} e */
  function onPush(e) {
    if (!reader) return;
    var page = rightPage();
    ...
    if (!dy) return;
    /* github#40, design/0026 -- every notch re-arms, so one latch spans one whole flick */
    armPush();
    var dir = dy > 0 ? 1 : -1;
    var span = page.scrollHeight - page.clientHeight;
    /* github#40, design/0026 -- D-1: a page that cannot scroll is already at its limit */
    ...
    /* github#40, design/0026 -- forward arrives at the top, back at the bottom */
    pushSpent = true;
    pushAt = 0;
    releasePush(true);
  ...
  /* github#40, design/0026 -- on the right page; the contents cannot reach it */
  ...
  API = {
    ...
    /** github#40, design/0026 -- the push, the band, and whether either is still going */
    overscroll: function () {
      var page = rightPage();
      return {
        dir: pushDir,
