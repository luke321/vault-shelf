...
function mountVaultShelf(root, data, options) {
  ...
  /**
   * github#36, design/0023 -- where an arrow key belongs to the caret, not to the book
  ...
  on(DOC, "keydown", function (e) {
    ...
    /* github#36, design/0023 -- a caret in a field is not a page waiting to turn */
